  ...
  <div class="navbar-wrapper">
	<div class="navbar-header">
	  <ul class="nav navbar-nav flex-row">
		...
		<li class="nav-item">
		<a class="navbar-brand" href="index.html"><img src="{{asset('app-assets/images/logo-icon.png')}}" alt="Quoteside" class="brand-logo" > <span class="brand-text"><img src="{{asset('app-assets/images/logo-text.png')}}" alt="Quoteside" class="img-fluid w-75"></span></a>
		</li>
