...
<body class="vertical-layout vertical-menu 2-columns   menu-expanded fixed-navbar" data-open="click" data-menu="vertical-menu" data-col="2-columns">
	...
	<div class="main-menu menu-fixed menu-dark menu-accordion    menu-shadow " data-scroll-to-active="true">
      <div class="main-menu-content">
          ...
          <li class=" nav-item"><a href="{{url('staff/dashboard')}}"><i class="icon-home"></i>
		 ...
		 <li class="nav-item"><a href="{{url('staff/today-schedule')}}"><i class="icon-calendar"></i><span class="menu-title" data-i18n="nav.form_repeater.main">Schedule</span></a>
          </li>
		    <li class="nav-item"><a href="{{url('staff/past-visit')}}"><i class="icon-briefcase"></i><span class="menu-title" data-i18n="nav.form_repeater.main">Past Visits</span></a>
          </li>
		  <li class="nav-item"><a href="{{url('staff/timesheet')}}"><i class="icon-clock"></i><span class="menu-title" data-i18n="nav.form_repeater.main">Timesheet</span></a>
          </li>
