								...
								<div class="card-content collapse show">
									...
									{{-- error --}}
										 @if(session('success'))
											...
											@endif
											<form id="addStaffForm" class="form-horizontal form-simple" method="POST" action="{{ url('admin/submitaddClient') }}" novalidate  enctype="multipart/form-data">
											@csrf
											@if(isset($id) && !empty($id))
											...
											<div class="form-body">
												<div class="row">
													...
													<div class="col-md-6 col-sm-12 col-12">
														<div class="form-group">
															<label for="projectinput3">Client Name</label>
													...
													<div class="col-md-6 col-sm-12 col-12">
														<div class="form-group">
															<label for="projectinput4">Client Photo</label>
													...
													<div class="col-md-6 col-sm-12 col-12 leaving_reason_div" <?php if(isset($staffDetail->status) && $staffDetail->status == "2"){ ?> style="display:block;" <?php }else{ ?> style="display:none;" <?php }  ?>>
														<div class="form-group">
															...
															<select name="leaving_reason" class="form-control">
																<option <?php if(isset($staffDetail->leaving_reason) && $staffDetail->leaving_reason == "Discharged"){ echo "selected"; }  ?> value="Discharged">Discharged</option>
																<option <?php if(isset($staffDetail->leaving_reason) && $staffDetail->leaving_reason == "Moved to hospital"){ echo "selected"; }  ?> value="Moved to hospital">Moved to hospital</option>
																<option <?php if(isset($staffDetail->leaving_reason) && $staffDetail->leaving_reason == "Passwed away"){ echo "selected"; }  ?> value="Passwed away">Passwed away</option>
