        ...
        <div class="content-body"><!-- Sales stats -->
							...
							<div class="panel-body">
								...
								@endif
									...
									@endif
								<form class="form-horizontal" method="POST" action="{{ url('client/changePassword') }}">
									{{ csrf_field() }}


                                    <div class="form-group{{ $errors->has('current-password') ? ' has-error' : '' }}">
										<label for="new-password" class="col-md-12 control-label">Username</label>

									<div class="col-md-12">
											<input type="text" class="form-control" value="<?php echo Auth::user()->username; ?>" readonly>
										</div>
									</div>
